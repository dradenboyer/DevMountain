...
sayHelloButton.addEventListener('mouseout', returnColor);
...
const repeatMyParam = () => {
    axios.get(baseURL + '/repeat/DRADEN')
    .then(response => {
...
// CODE HERE
const attach = () => {
    axios.get(baseURL + '/query-test/?hello beautiful world/what is up my friends and family')
    .then(response => {
        console.log(response)
    })
}

document.getElementById('query-button').addEventListener('click', attach)
